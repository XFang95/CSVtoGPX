...
The csvtogpxseg.py script will connect the adjacent dots based on time stamp (within 60s with adjacent dots) and space (within 1.0 km with adjacent dots). The criteria can be adjusted based on your setting in the Footprint app.
